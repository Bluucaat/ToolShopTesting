class HomePage {
  ...
  get minimumPriceSlider() {
    return $('span.ngx-slider-pointer-min');
  }
  get maximumPriceSlider() {
  ...
  get foundProductName() {
    return $('[data-test="product-name"]');
  }
  get categoryElement() {
    return $('[aria-label="category"]');
  }
  get noProductsMessageElement() {
    return $(`//div[contains(text(), "there are no products found")]`);
  }
  subCategoryElement(subCategory) {
    return $(`//div[@class="checkbox"]//label[contains(text(), "${subCategory}")]`);
  }
